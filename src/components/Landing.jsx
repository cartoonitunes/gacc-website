                ...
                <div className="common-container">
                  <div className="container">
                    <div className="mb-5 mb-lg-0 row">
                      <div className="col-lg-4 col-12 offset-lg-4"><img className="img-fluid d-block mx-auto custom-logo pt-4" src="https://ik.imagekit.io/l7p0svlzgvd/gacc_logo_white_B26qrGJUj.png" alt="gacc header logo" width="300px" height="300px" /></div>
